        ...
        <div className="absolute right-full mr-3.5 bottom-0 bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl border border-stone-200 p-3 z-50 animate-scale-in text-stone-800 flex flex-col gap-2.5 min-w-[260px]">
          ...
          <div className="grid grid-cols-5 gap-1.5">
            ...
            <button
              ...
              className={`p-2 rounded-2xl border flex flex-col items-center justify-center gap-1 transition cursor-pointer ${
                isAiSubmenuOpen
            ...
            >
              <div className="w-7 h-7 rounded-xl bg-emerald-100 text-[#006241] flex items-center justify-center font-bold">
                <Sparkles className="w-3.5 h-3.5 text-[#006241]" />
              </div>
              <span className="text-[9.5px] font-black tracking-tight">Auto AI</span>
            </button>
            ...
            {onOpenDispositionsModal && (
              <button
                ...
                className="p-2 rounded-2xl bg-white hover:bg-amber-50/60 border border-stone-200 text-stone-700 hover:text-amber-900 flex flex-col items-center justify-center gap-1 transition cursor-pointer shadow-2xs"
              >
                ...
                <span className="text-[9.5px] font-bold tracking-tight">Dyspo</span>
              </button>
            )}

            {/* 3. WSPARCIE MIĘDZYKAWIARNIANE (SUP) */}
            {onOpenSupportModal && (
              <button
                type="button"
                onClick={() => {
                ...
                title="Asystent Wsparcia Międzykawiarnianego (Oddawanie i zamiany zmian)"
                className="p-2 rounded-2xl bg-white hover:bg-teal-50/70 border border-stone-200 text-stone-700 hover:text-teal-900 flex flex-col items-center justify-center gap-1 transition cursor-pointer shadow-2xs group"
              >
                <div className="w-7 h-7 rounded-xl bg-teal-100 text-teal-800 flex items-center justify-center font-bold group-hover:scale-105 transition-transform">
                  <ArrowRightLeft className="w-3.5 h-3.5 text-teal-700" />
                </div>
                <span className="text-[9.5px] font-bold tracking-tight">Wsparcie</span>
              </button>
            )}
            ...
            {onToggleTorView && (
              ...
              >
                ...
                <span className="text-[9.5px] font-bold tracking-tight">{isTorActive ? 'Siatka' : 'TOR'}</span>
              </button>
            )}
            ...
            {onOpenVersionModal && (
              <button
                ...
                className="p-2 rounded-2xl bg-white hover:bg-stone-50 border border-stone-200 text-stone-700 hover:text-[#006241] flex flex-col items-center justify-center gap-1 transition cursor-pointer shadow-2xs"
              >
                ...
                <span className="text-[9.5px] font-bold tracking-tight">Wersje</span>
              </button>
            )}
