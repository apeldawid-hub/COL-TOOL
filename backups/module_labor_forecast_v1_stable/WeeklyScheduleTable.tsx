...
import { Users, Edit3, Check, CalendarDays, Info, Clock, Target, CheckCircle2 } from 'lucide-react';
            ...
            {rows.map((r) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Grafik (Scheduled Hours - Wprowadzany przez SM) */}
                  <td className="py-3.5 px-4 text-right font-black">
                    {isEditingSched ? (
                      <div className="flex items-center justify-end space-x-1">
                        <input
                        ...
                        <button
                          ...
                          className="p-1 rounded-md bg-[#6366F1] hover:bg-[#4F46E5] text-white shadow-xs"
                        >
                          <Check className="w-3.5 h-3.5" />
                        </button>
                      </div>
                  ...
                  <td className="py-3.5 px-3 text-center">
                    <button
                      ...
                      title="Podgląd godzin i logowań pracowników"
                      className="p-1.5 rounded-lg bg-white hover:bg-[#E8F5E9] text-[#006241] border border-[#D0DCD6] hover:border-[#006241] shadow-xs transition-colors inline-flex items-center"
                    >
                      <Users className="w-3.5 h-3.5" />
                    </button>
                  </td>
            ...
            <tr className="bg-[#F8FAF9] border-t-2 border-[#D0DCD6] font-black text-xs text-[#1E3932]">
              ...
              <td className="py-3 px-4 text-right text-[#6366F1]">
                {rows.some((r) => r.scheduledHours)
                  ? `${rows.reduce((s, r) => s + (r.scheduledHours || 0), 0).toFixed(1)} h`
                  : '—'}
              </td>
