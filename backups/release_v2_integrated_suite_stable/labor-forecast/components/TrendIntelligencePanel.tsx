        ...
        <div className="my-5 pt-4 border-t border-[#EEF2F0]">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 mb-3">
            <h4 className="text-xs font-black text-[#1E3932] uppercase tracking-wider flex items-center gap-1.5">
              ...
              Rozkład Godzin w Dniach Tygodnia (Historia MAPAL vs Floor Hours):
            </h4>
            <span className="text-[10px] text-[#5C6F68] font-bold">
              Baza tygodnia: Pn–Sob 40h / Nd 32h (Floor 272h)
            </span>
          </div>
