        ...
        <div className="p-6 overflow-y-auto space-y-6">
          ...
          <div className="p-3.5 rounded-2xl bg-stone-50 border border-stone-200 text-stone-600 text-xs flex items-start gap-2.5">
            ...
            <div className="space-y-1 text-[11px] leading-relaxed">
              <p>
                <strong>Zasada podziału robocizny w kawiarni:</strong> Godziny dyżurów kierowniczych w lokalu Janki (18120) pokrywają część minimalnego Floor Hours (32h/dzień = 4 osoby na sali).
              </p>
              <p>
