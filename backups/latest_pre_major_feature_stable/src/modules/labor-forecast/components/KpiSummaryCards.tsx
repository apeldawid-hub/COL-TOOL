      ...
      <div className="bg-white border border-[#E2E8E5] rounded-2xl p-5 shadow-xs relative overflow-hidden transition-all hover:shadow-md">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center space-x-1.5">
            ...
            {onOpenNcSettings && (
              <button
                onClick={onOpenNcSettings}
                title="Konfiguracja godzin Non-Coverage (NC)"
                className="p-1 rounded-md hover:bg-[#E8F5E9] text-[#006241] transition-colors"
              >
        ...
        <div className="space-y-2">
          ...
          {/* Kluczowa metryka: Pula na dodatkowe zmiany */}
          <div className="pt-1.5 space-y-1">
            {summary.ncBudgetTotal !== undefined && summary.ncBudgetTotal > 0 && (
              <div className="flex justify-between text-[11px] text-[#5C6F68]">
                <span>Floor: <strong className="text-[#1E3932]">{summary.totalFloorHoursMonth.toFixed(1)} h</strong></span>
                <span>NC: <strong className="text-[#1E3932]">{summary.ncBudgetTotal.toFixed(1)} h</strong></span>
              </div>
            )}
