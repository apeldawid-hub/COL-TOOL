      ...
      <div className="p-3 border-t border-white/10 space-y-1">
        ...
        {onOpenImportModal && (
          <button
            ...
            title={isCollapsed ? 'Import Fichajes' : undefined}
          ...
          >
            ...
            {!isCollapsed && <span>Import Fichajes</span>}
          </button>
        )}
        ...
        {onOpenSettings && (
          <button
            ...
            title={isCollapsed ? 'Ustawienia AOP' : undefined}
            className={`w-full flex items-center rounded-2xl text-xs font-semibold text-emerald-100/80 hover:text-white hover:bg-white/10 transition-colors cursor-pointer ${
              isCollapsed ? 'justify-center p-3' : 'px-3.5 py-2 space-x-3'
            }`}
          >
            <Settings className="w-4 h-4 text-emerald-300" />
            {!isCollapsed && <span>Ustawienia AOP & NC</span>}
          </button>
        )}
